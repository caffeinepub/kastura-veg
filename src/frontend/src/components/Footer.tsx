import { ExternalLink, Leaf, MapPin, Phone } from "lucide-react";
...
export function Footer() {
  ...
  return (
    <footer className="bg-k-green-deep text-white">
      <div className="container mx-auto px-4 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <p className="text-white/65 text-sm leading-relaxed mb-4">
              Pure vegetarian cuisine crafted with love in the heart of Keshav
              Nagar, Mundhwa, Pune.
            </p>
            <a
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2 items-center">
                <svg
                  viewBox="0 0 24 24"
                  className="w-4 h-4 text-amber-300 flex-shrink-0 fill-current"
                  aria-hidden="true"
                >
        ...
        <div className="mt-10 pt-6 border-t border-white/15 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-white/50 text-sm text-center md:text-left">
            © {year} Kastura Veg. All rights reserved.
          </p>
